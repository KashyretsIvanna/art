...
export function premiumExpiredTemplate(name: string) {
                              ...
                              <tbody>
                                ...
                                <tr
                                  ...
                                  <th
                                    ...
                                    >
                                    <img
                                    src="https://i.imgur.com/8llYu65.png"
                                    width="100%"
                                    alt="Logo"
                                    style="
                                    -ms-interpolation-mode: bicubic;
                                              ...
                                              <tbody>
                                                <tr
                                                  ...
                                                  <th
                                                    ...
                                                    >
                                                    <img
                                                    src="https://i.imgur.com/EhmD691.png"
                                                    width="100%"
                                                    alt="Logo"
                                                    style="
                                                    -ms-interpolation-mode: bicubic;
...
font-style: normal;
font-weight: 400;
line-height: normal;">You can explore all premium plans in ArtDate application.</p> 
